...
src_prepare() {
	...
	# xanmod patch
	eapply "${FILESDIR}/xanmod/linux-6.5.y-xanmod/intel/0001-sched-fair-Record-the-average-duration-of-a-task.patch"
	eapply "${FILESDIR}/xanmod/linux-6.5.y-xanmod/intel/0002-sched-fair-Introduce-SIS_CURRENT-to-wake-up-short-ta.patch"
	...
	eapply "${FILESDIR}/xanmod/linux-6.5.y-xanmod/intel/0005-firmware-Enable-stateless-firmware-loading.patch"
        eapply "${FILESDIR}/xanmod/linux-6.5.y-xanmod/intel/0006-locking-rwsem-spin-faster.patch"
	# eapply "${FILESDIR}/xanmod/linux-6.5.y-xanmod/intel/0007-drivers-initialize-ata-before-graphics.patch"
