...
SRC_URI="${KERNEL_URI} ${GENPATCHES_URI}
    https://cdn.kernel.org/pub/linux/kernel/projects/rt/${KV_MAJOR}.${KV_MINOR}/older/patches-${KV_MAJOR}.${KV_MINOR}-${RT_VERSION}.tar.xz
"
...
src_unpack() {
    ...
    unpack patches-${KV_MAJOR}.${KV_MINOR}-${RT_VERSION}.tar.xz
