...
SLOT="0"
IUSE="X aqua debug +glib gtk-doc test fontconfig"
...
RDEPEND="
	...
	fontconfig? ( >=media-libs/fontconfig-2.13.92[${MULTILIB_USEDEP}] )
	fontconfig? ( >=media-libs/freetype-2.13:2[png,${MULTILIB_USEDEP}] )
