...
PATCHES=(
	"${FILESDIR}"/synergy-1.10.1-pthread.patch
	"${FILESDIR}"/synergy-1.10.1-internal-gmock-gtest.patch
	"${FILESDIR}"/synergy-1.10.1-gtest.patch
)
...
src_configure() {
	local mycmakeargs=(
		...
		-DSYNERGY_ENTERPRISE=$(usex enterprise)
	)
